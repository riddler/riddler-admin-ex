defmodule RiddlerAdminWeb.UserAuth do
  ...
  the `current_scope`:
      ...
      defmodule RiddlerAdminWeb.PageLive do
        use RiddlerAdminWeb, :live_view

        on_mount {RiddlerAdminWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{RiddlerAdminWeb.UserAuth, :require_authenticated}] do
